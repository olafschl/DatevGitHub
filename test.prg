 * Hier erfolgt die �bergabe an KHK 18.09.22 test git ge�ndert nue jetz in gitlab
...
>>>>>>> OliTestPrg
 ...
 LOCAL pr_anz,pr_summe,lanrede,dsatz
 	...
 	*
	SET filter to
	* Hier wird die Debitorennr �bertragen 
	...
	* da es zwei Zahlungen f�r eine Rechnung geben kann
	ok_f=.f.
	IF ok_f=.t.
	*
	...
	* hier werden nur die Ums�tze aus dem Hotel nicht aus Argus �bermittelt. 	
 	SELECT datev
 	SET Order to tag3
 	GO top
 	* brow
	...
	* hier werden nur die Ums�tze aus Argus �bermittelt
	kasse=.f.
